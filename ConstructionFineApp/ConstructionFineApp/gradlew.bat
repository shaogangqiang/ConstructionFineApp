...
@rem
@rem Licensed under the Apache License, Version 2.0 (the "See LICENSE file" accompanying this file. The
@rem License is also available at https://www.apache.org/licenses/LICENSE-2.0
@rem
